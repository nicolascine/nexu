...
export function getRecentCommits(path: string, count: number = 5): SessionContext['git']['recentCommits'] {
...
export function inferCurrentTask(context: Partial<SessionContext>): { summary: string; branch: string } {
